CREATE TYPE "public"."experience_levels" AS ENUM('junior', 'mid-level', 'senior');--> statement-breakpoint
CREATE TYPE "public"."jobListing_statuses" AS ENUM('draft', 'published', 'delisted');--> statement-breakpoint
CREATE TYPE "public"."jobListing_types" AS ENUM('full-time', 'part-time', 'contract', 'internship');--> statement-breakpoint
...
CREATE TYPE "public"."application_stages" AS ENUM('denied', 'applied', 'interested', 'interviewed', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listings" (
	...
	"wageInterval" "wage_interval",
	"stateAbbreviation" varchar,
	"city" varchar,
	"isFeatured" boolean DEFAULT false NOT NULL,
	"locationRequirement" "location_requirement" NOT NULL,
	"experienceLevel" "experience_levels" NOT NULL,
	"status" "jobListing_statuses" DEFAULT 'draft' NOT NULL,
	"type" "jobListing_types" NOT NULL,
...
CREATE TABLE "job_listing_applications" (
	...
	"coverLetter" text,
	"rating" integer,
	"stage" "application_stages" DEFAULT 'applied' NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone NOT NULL,
